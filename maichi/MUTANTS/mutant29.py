"""MUTANT 29 | Variable Replacement | Line 16: destination nodes omitted from self.nodes"""
...
class Graph:
    def __init__(self, filename):
        ...
        for edge in graph_edges:
            self.nodes.update([edge[0]])  # MUTATION: edge[1] removed — destination-only nodes missing
