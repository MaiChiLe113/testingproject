"""MUTANT 31 | Function Replacement | Line 47: 'path.appendleft(current_node)' changed to 'path.append(current_node)'"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        ...
        while previous_node[current_node] is not None:
            path.append(current_node)  # MUTATION: appendleft -> append (path reversed)
