"""MUTANT 22 | Constant Replacement | Line 25: start node initialised to 1 instead of 0"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        ...
        distance_from_start = {
            node: (1 if node == start_node else INFINITY) for node in self.nodes  # MUTATION: 0 -> 1
        }
