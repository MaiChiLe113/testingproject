"""MUTANT 35 | Variable Replacement | Line 51: 'distance_from_start[end_node]' changed to 'distance_from_start[start_node]'"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        ...
        return path, distance_from_start[start_node]  # MUTATION: end_node -> start_node
