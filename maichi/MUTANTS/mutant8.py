"""MUTANT 8 | Variable Replacement | Line 37: 'distance_from_start[current_node] + distance' changed to 'distance + distance'"""
    ...
    def shortest_path(self, start_node, end_node):
        ...
        while unvisited_nodes:
            ...
            for neighbor, distance in self.adjacency_list[current_node]:
                new_path = distance + distance  # MUTATION: dropped distance_from_start[current_node]
