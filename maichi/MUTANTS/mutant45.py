"""MUTANT 45 | Statement Deletion | Line 23: '.copy()' removed from unvisited_nodes initialisation"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        unvisited_nodes = self.nodes  # MUTATION: .copy() removed — traversal mutates self.nodes
        distance_from_start = {
