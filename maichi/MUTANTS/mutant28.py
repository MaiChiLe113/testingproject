"""MUTANT 28 | Variable Replacement | Line 20: neighbor in tuple changed to self — all edges become self-loops"""
...
class Graph:
    def __init__(self, filename):
        ...
        for edge in graph_edges:
            self.adjacency_list[edge[0]].add((edge[0], edge[2]))  # MUTATION: edge[1] -> edge[0] (self-loop)
