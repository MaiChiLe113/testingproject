"""MUTANT 17 | Variable Replacement | Line 40: 'previous_node[neighbor] = current_node' changed to '= neighbor'"""
        ...
        while unvisited_nodes:
            ...
            for neighbor, distance in self.adjacency_list[current_node]:
                ...
                if new_path < distance_from_start[neighbor]:
                    ...
                    previous_node[neighbor] = neighbor  # MUTATION: current_node -> neighbor (self-loop)
