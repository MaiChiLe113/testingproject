"""MUTANT 18 | Variable Replacement | Line 40: indices swapped — 'previous_node[neighbor] = current_node' changed to '[current_node] = neighbor'"""
        ...
        while unvisited_nodes:
            ...
            for neighbor, distance in self.adjacency_list[current_node]:
                ...
                if new_path < distance_from_start[neighbor]:
                    ...
                    previous_node[current_node] = neighbor  # MUTATION: indices swapped
