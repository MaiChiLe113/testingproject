"""MUTANT 44 | Constant Replacement | Line 20: 'edge[2]' changed to '1' — all edge weights replaced with constant 1"""
...
class Graph:
    def __init__(self, filename):
        ...
        for edge in graph_edges:
            self.adjacency_list[edge[0]].add((edge[1], 1))  # MUTATION: edge[2] -> 1 (unit weight)
