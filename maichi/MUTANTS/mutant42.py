"""MUTANT 42 | Variable Replacement | Line 37: 'distance_from_start[current_node]' changed to 'distance_from_start[start_node]'"""
    ...
    def shortest_path(self, start_node, end_node):
        ...
        while unvisited_nodes:
            ...
            for neighbor, distance in self.adjacency_list[current_node]:
                new_path = distance_from_start[start_node] + distance  # MUTATION: current_node -> start_node
