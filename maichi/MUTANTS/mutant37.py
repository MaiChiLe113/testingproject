"""MUTANT 37 | Statement Deletion | Line 48: 'current_node = previous_node[current_node]' removed — infinite loop in reconstruction"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        ...
        while previous_node[current_node] is not None:
            ...
            pass  # MUTATION: current_node = previous_node[current_node] deleted (infinite loop)
