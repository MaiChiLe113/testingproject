"""MUTANT 25 | Statement Deletion | Line 23: 'self.nodes.copy()' changed to 'set()' — empty unvisited set"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        unvisited_nodes = set()  # MUTATION: self.nodes.copy() -> set() (empty — loop never runs)
        distance_from_start = {
