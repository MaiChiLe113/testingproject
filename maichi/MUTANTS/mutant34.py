"""MUTANT 34 | Logical Operator Replacement | Line 46: 'is not None' changed to 'is None' in path reconstruction loop"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        ...
        while previous_node[current_node] is None:  # MUTATION: 'is not' -> 'is'
