"""MUTANT 19 | Statement Deletion | Lines 42-43: 'if current_node == end_node: break' removed (likely equivalent)"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        ...
        while unvisited_nodes:
            ...
            # MUTATION: if current_node == end_node: break  (removed — likely equivalent)
        path = deque()
