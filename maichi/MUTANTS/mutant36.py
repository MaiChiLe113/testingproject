"""MUTANT 36 | Variable Replacement | Line 45: 'current_node = end_node' changed to 'current_node = start_node' in reconstruction init"""
    ...
    def shortest_path(self, start_node, end_node):
        ...
        while unvisited_nodes:
            ...
            if current_node == end_node:
                break 
        path = deque()
        current_node = start_node  # MUTATION: end_node -> start_node (reconstruction starts at wrong node)
