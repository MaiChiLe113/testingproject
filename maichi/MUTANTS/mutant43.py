"""MUTANT 43 | Variable Replacement | Line 40: 'current_node' changed to 'start_node' in predecessor assignment"""
        ...
        while unvisited_nodes:
            ...
            for neighbor, distance in self.adjacency_list[current_node]:
                ...
                if new_path < distance_from_start[neighbor]:
                    ...
                    previous_node[neighbor] = start_node  # MUTATION: current_node -> start_node
