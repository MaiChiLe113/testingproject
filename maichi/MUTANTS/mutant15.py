"""MUTANT 15 | Variable Replacement | Line 39: 'distance_from_start[neighbor]' changed to 'distance_from_start[current_node]'"""
        ...
        while unvisited_nodes:
            ...
            for neighbor, distance in self.adjacency_list[current_node]:
                ...
                if new_path < distance_from_start[neighbor]:
                    distance_from_start[current_node] = new_path  # MUTATION: neighbor -> current_node
