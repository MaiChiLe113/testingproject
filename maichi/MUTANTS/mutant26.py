"""MUTANT 26 | Statement Deletion | Line 33: 'unvisited_nodes.remove(current_node)' removed"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        ...
        while unvisited_nodes:
            ...
            pass  # MUTATION: unvisited_nodes.remove(current_node) deleted (infinite loop)
