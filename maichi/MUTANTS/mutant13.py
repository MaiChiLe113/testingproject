"""MUTANT 13 | Relational Operator Replacement | Line 34: '== INFINITY' changed to '> INFINITY' (dead code — potentially equivalent)"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        ...
        while unvisited_nodes:
            ...
            if distance_from_start[current_node] > INFINITY:  # MUTATION: '==' -> '>' (dead code)
                break
