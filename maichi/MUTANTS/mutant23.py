"""MUTANT 23 | Constant Replacement | Line 25: all nodes initialised to 0 (constant replaces conditional)"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        ...
        distance_from_start = {
            node: 0 for node in self.nodes  # MUTATION: conditional removed, always 0
        }
