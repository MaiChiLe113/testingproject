"""MUTANT 30 | Variable Replacement | Line 12: edge source and destination swapped at parse time"""
    ...
    def __init__(self, filename):
        ...
        with open(filename) as fhandle:
            for line in fhandle:
                ...
                graph_edges.append((edge_to, edge_from, float(cost)))  # MUTATION: edge_from<->edge_to swapped
