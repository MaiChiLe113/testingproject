"""MUTANT 24 | Variable Replacement | Line 27: 'None' changed to 'node' in previous_node initialisation"""
...
class Graph:
    ...
    def shortest_path(self, start_node, end_node):
        ...
        previous_node = {node: node for node in self.nodes}  # MUTATION: None -> node (infinite loop)
